...
public class MyIssuesAdapter extends RecyclerView.Adapter<MyIssuesAdapter.MyViewHolder> {

    Context context;
    ArrayList<man_issues_data> list;
    private boolean isButtonVisible;
    private MyJobHistoryAdaptar.OnButtonClickListener onButtonClickListener;

    public MyIssuesAdapter(Context context, ArrayList<man_issues_data> list, boolean isButtonVisible) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.equipmentId.setText(manIssuesData.getEquipmentId());
        ...
        if (holder.button17 != null) {
            holder.button17.setVisibility("pending".equalsIgnoreCase(manIssuesData.getStatus()) ? View.GONE : View.GONE);
