...
public class MymanJobHistoryAdaptar extends RecyclerView.Adapter<MymanJobHistoryAdaptar.MyViewHolder> {

    Context context;
    ArrayList<job_history_data> list;
    boolean isButtonVisible;

    public MymanJobHistoryAdaptar(Context context, ArrayList<job_history_data> list, boolean b) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if (holder.button17 != null) {
            holder.button17.setVisibility("pending".equalsIgnoreCase(jobHistoryData.getStatus()) ? View.GONE : View.GONE);
        }
